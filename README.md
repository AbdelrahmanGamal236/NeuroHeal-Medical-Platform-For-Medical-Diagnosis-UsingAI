...
```bash
git clone https://github.com/AbdelrahmanGamal236/NeuroHeal-Medical-Platform-For-Medical-Diagnosis-UsingAI.git
cd NeuroHeal-Medical-Platform-For-Medical-Diagnosis-UsingAI
```
